-- =====================================================================
-- TomoScoreCore.lua — TomoScore integrated into MythicHub (MythicPlus)
-- Addon table, color palette, utilities.
-- =====================================================================

local L = MythicHub_L

MythicHub_TomoScore = MythicHub_TomoScore or {}
local TS = MythicHub_TomoScore
...
-- ── DB access ─────────────────────────────────────────────────────────────────
function TS:GetDB()
    return MythicHubDB and MythicHubDB.TomoScore
end
